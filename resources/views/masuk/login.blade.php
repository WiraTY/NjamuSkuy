        ...
        <div class="row no-gutters">
          ...
          <div class="col-md-7">
            <div class="card-body">
              ...
              <p class="login-card-description">Masuk ke dalam akunmu</p>
              ...
              <form action="{{ route('postLogin') }}" method="POST">
                @csrf
                  ...
                  <button class="btn btn-block login-btn mb-4" style="background-color: #ffc107;">Login</button>
                </form>
                <a href="#!" class="forgot-password-link">Lupa Password ?</a>
                <p class="login-card-footer-text">Tidak Punya akun? <a href="/register" class="text-reset"><u>Daftar disini</u></a></p>
