            ...
            <div class="card-body">
              ...
              <div style="display:table; width: 100%;">
                <div style="text-align: right; display:table-cell;">
                  <a href="{{ url('admin-admins/create') }}"><button type="button" class="btn btn-primary" style="margin-right: 1%;"><i class="bi bi-plus-square me-1"></i>Tambah Data</button></a>
                </div>
              </div>
              ...
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="{{ url('/admin-admins/'.$data->id) }}"><button class="btn btn-primary"><i class="bi ri-eye-line me-1"></i>Tampil</button></a></td>
                    <td><a href="{{ url('/admin-admins/'.$data->id.'/edit') }}"><button class="btn btn-warning "><i class="bi ri-edit-2-line me-1"></i>Ubah</button></a></td>
                     <td>
                        <form action="{{ url('/admin-admins/'.$data->id) }}" method="POST">
                            @csrf
