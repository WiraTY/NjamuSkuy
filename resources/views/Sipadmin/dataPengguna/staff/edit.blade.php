        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3" action="{{ url('staff-admins/'.$data->id) }}" method="POST">
                @csrf                
                <input type="hidden" name="_method" value="PATCH">     
                <div class="col-6">
                    <label for="nama_staff" class="form-label">Nama Staff</label>
                    <input type="text" class="form-control @error('nama_staff') is-invalid @enderror" id="nama_staff" name="nama_staff" placeholder="nama staff" value="{{ $data->nama_staff }}">
                    @error('nama_staff')
                  ...
                  <fieldset class="row mb-1">
                    ...
                    <div class="col-sm-10">
                      <div class="form-check">
                        <input class="form-check-input" type="radio" name="kelamin" id="kelamin" v {{ $data->kelamin =='L' ? 'checked': '' }}>
                        <label class="form-check-label" for="kelamin">alue="L"
                          Laki-laki
                        </label>
                      </div>
                      <div class="form-check">
