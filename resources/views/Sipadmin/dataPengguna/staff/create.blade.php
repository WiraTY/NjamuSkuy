            ...
            <div class="card-body">
              ...
              <form class="row g-3" action="{{ url('staff-admins') }}" method="POST">
                ...
                <div class="col-6">
                    ...
                    <input type="text" class="form-control @error('nama_staff') is-invalid @enderror" id="nama_staff" name="nama_staff" placeholder="nama staff" value="{{ old('nama_staff') }}">
                    @error('nama_staff')
                  ...
                  <fieldset class="row mb-1">
                    ...
                    <div class="col-sm-10">
                      <div class="form-check">
                        <input class="form-check-input" type="radio" name="kelamin" id="kelamin" value="L" {{ old('kelamin')=='L' ? 'checked': '' }}>
                        <label class="form-check-label" for="kelamin">
                          Laki-laki
                        </label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input" type="radio" name="kelamin" id="kelamin" value="P" {{ old('kelamin')=='P' ? 'checked': '' }}>
                        <label class="form-check-label" for="kelamin">
                          Perempuan
                        </label>
                        @error('kelamin')
                ...
                <div class="col-6">
                  ...
                  <select name="posisi" id="posisi" class="form-select">
                    ...
                    {{ old('posisi')=='Barista' ? 'selected': '' }} >
                    Barista
                    </option>
                    <option value="Cheff"
                    {{ old('posisi')=='Cheff' ? 'selected': '' }} >
                    Cheff
                    </option>
                    <option value="Kasir"
                    {{ old('posisi')=='Kasir' ? 'selected': '' }} >
                    Kasir
                    </option>
                    <option value="Pelayan"
                    {{ old('posisi')=='Pelayan' ? 'selected': '' }} >
                    Pelayan
                    </option>
                  </select>
                  @error('posisi')
                ...
                <div class="col-12">
                    ...
                    <textarea name="alamat" id="alamat" name="alamat" class="form-control @error('alamat') is-invalid @enderror" placeholder="alamat"></textarea>
                    @error('alamat')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
