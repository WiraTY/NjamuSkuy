    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Tampil Artikel Jamu</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Tampil Artikel Jamu</h5>
              <!-- Vertical Form -->
              ...
              <form class="row g-3" action="{{ url('artikel-admins/'.$data->id) }}" method="POST">
                ...
                <div class="col-6">
                    ...
                    <input type="text" class="form-control @error('judul_artikel') is-invalid @enderror" id="judul_artikel" name="judul_artikel" placeholder="judul artikel" value="{{ $data->judul_artikel }}" disabled>
                    @error('judul_artikel')
                ...
                <div class="col-6">
                  ...
                  <select name="jamus_id" id="jamus_id" class="form-select" disabled>
                ...
                <div class="card-body">
                  ...
                  <!-- TinyMCE Editor -->
                  <textarea class="tinymce-editor" name="artikel" id="artikel" disabled>{{ $data->artikel }}</textarea><!-- End TinyMCE Editor -->
                  @error('artikel')
                      <div class="text-danger">{{ $message }}</div>
                  @enderror
                </div>
