    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Tampilkan Daftar Jamu</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Tampilkan Daftar Jamu</h5>
              <!-- Vertical Form -->
              <form class="row g-3" action="{{ url('jamu-admins') }}" method="POST">
                ...
                <div class="text-center">
                  <button type="reset" class="btn btn-secondary mt-4" onclick="location.href='{{ URL::previous() }}';">Kembali</button>
                </div>
                @endforeach
              </form><!-- Vertical Form -->
