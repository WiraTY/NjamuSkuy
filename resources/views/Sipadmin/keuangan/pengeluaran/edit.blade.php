    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Edit Data Pengeluaran</h5>
              <!-- Vertical Form -->
              ...
              <form class="row g-3" action="{{ url('pengeluaran-admins/'.$data->id) }}" method="POST">
                ...
                <div class="col-12">
                    ...
                    <input type="text" class="form-control @error('bentuk_pengeluaran') is-invalid @enderror" id="bentuk_pengeluaran" name="bentuk_pengeluaran" placeholder="kode jamu" value="{{ $data->bentuk_pengeluaran }}">
                ...
                <div class="col-12">
                  ...
                  <input type="number" class="form-control @error('total_pengeluaran') is-invalid @enderror" id="total_pengeluaran" name="total_pengeluaran" placeholder="total pengeluaran" value="{{ $data->total_pengeluaran }}">
