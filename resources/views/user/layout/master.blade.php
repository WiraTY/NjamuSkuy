...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-lg-between">
      ...
      <h1 class="logo me-auto me-lg-0"><a href="/home-user">Njamu<span>Skuy</span></a></h1>
      <!-- Uncomment below if you prefer to use an image logo -->
       <a href="index.html" class="logo me-auto me-lg-0"><img src="/assets/imgg/logo.png" alt="" class="img-fluid"></a>

      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          <li><a class="nav-link scrollto @yield('menuHome')" href="/home-user">Home</a></li>
          ...
          <li><a class="nav-link scrollto @yield('menuKeranjang')" href="/keranjang">Keranjang</a></li>
          <li><a class="nav-link scrollto @yield('menuKontak')" href="/contact">Contact</a></li>
          <li class="dropdown @yield('menuProfil')" style="margin-left: 5%;"><a href=""><span>{{ Session::get('nama') }}</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
